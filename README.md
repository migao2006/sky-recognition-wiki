...
第三、四批核對 6 份原文，移除把禮包或飛行三級動作誤當畢業的進度，修回零進度、1/3、1/2 與 2/3，補回原文明确列出的漏季；沒有唯一禮包依據的 35／11／32／41 包保持未知。三筆明寫無翼的帳號不再標為一般帳號，不另行推定無翼溢價；一筆有刷退紀錄的來源降為低品質參考。「3,300 台幣左右」仍保留為原文約價，不假造成交價或上下界。總數仍為 399 筆，中斷／大斷分組 83／116 筆、few／medium／many 禮包分組 115／71／83 筆、一般帳號分組 256 筆；30 季價格數值與分類乘數不變，僅更新證據權重及分組診斷。
