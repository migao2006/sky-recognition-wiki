...
第三批核對 3 份原文，移除把王子、音韻、九色鹿與姆明禮包誤當畢業的進度，修回織光 2/3、狂歡 1/2；沒有唯一禮包依據的 35／11 包保持未知。兩筆明寫無翼的帳號不再標為一般帳號，不另行推定無翼溢價；一筆有刷退紀錄的來源降為低品質參考。總數仍為 399 筆，中斷分組 85 筆、few／medium 禮包分組 115／72 筆、一般帳號分組 257 筆；30 季價格數值與分類乘數不變，僅更新證據權重及分組診斷。
