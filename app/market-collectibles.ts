...
const importantPackageProfiles = defineProfiles(
  ...
  [
    ...
    ["Moonlight Lantern", "燈籠", undefined, ["Lantern"]],
    ["Days of Summer Umbrella", "陽傘", undefined, ["Summer Parasol"]],
...
const standardPaidProfiles = defineProfiles(
  ...
  [
    ...
    ["Fortune Hand Fan", "幸運扇子", undefined, ["Days of Fortune Hand Fan"]],
    ...
    ["Anniversary Popcorn", "週年爆米花", "anniversary-cinema-set", ["Anniversary Popcorn Prop"]],
